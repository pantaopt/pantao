...
- (void)initSearchBar{
    ...
    CGFloat cancelBtnX = UISCREENWIDTH - 65;
...
- (void)initWarningLabel{
    ...
    UILabel *warningL = [[UILabel alloc] initWithFrame:CGRectMake((UISCREENWIDTH - 100)/2, (UISCREENHEIGHT - 40)/2 - 100, 100, 40)];
    warningL.text = @"无结果";
